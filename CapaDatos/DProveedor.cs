...
namespace CapaDatos
{
    public class DProveedor
    {
        ...
        public string Pro_Num_Doc
        {
            get { return _Pro_Num_Doc; }
            set { _Pro_Num_Doc = value; }
        }
        ...
        public DProveedor(int idproveedor,string pro_num_doc, string nombre, string direccion, string telefono, string email, string textobuscar)
        {
            this.Id_Proveedor = idproveedor;
            this.Pro_Num_Doc = pro_num_doc;
            this.Nombre = nombre;
        ...
        public string Insertar(DProveedor Proveedor)
        {
            ...
            try
            {
                ...
                SqlParameter ParPro_Num_Doc = new SqlParameter();
                ParPro_Num_Doc.ParameterName = "@documento_proveedor";
                ParPro_Num_Doc.SqlDbType = SqlDbType.VarChar;
                ParPro_Num_Doc.Size = 15;
                ParPro_Num_Doc.Value = Proveedor.Pro_Num_Doc;
                SqlCmd.Parameters.Add(ParPro_Num_Doc);
        ...
        public DataTable BuscarNum_Documento(DProveedor Proveedor)
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spbuscar__proveedor_num_documento";
                SqlCmd.CommandType = CommandType.StoredProcedure;
